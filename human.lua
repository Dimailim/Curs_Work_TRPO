...
function human:draw()
  ...
  for i = 1, self.parts.number do
    ...
    love.graphics.line(self.x-100, self.y-60, self.x-100, self.y+240)
    love.graphics.line(self.x, self.y-60, self.x-100, self.y-60)
    love.graphics.line(self.x, self.y-60, self.x, self.y-50)
